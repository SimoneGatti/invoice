...
public class ReceiptTest {
    ...
    public void receipt1ShouldPass() {
        ...
        assertEquals("total must be 0", input.getTaxAmount(), new BigDecimal("1.50"));
        assertEquals("tax amount must be 0", input.getTotal(), new BigDecimal("29.83"));
    }
    ...
    public void receipt2ShouldPass() {
        ...
        assertEquals("total must be 0", input.getTaxAmount(), new BigDecimal("7.65"));
        assertEquals("tax amount must be 0", input.getTotal(), new BigDecimal("65.15"));
    }
    ...
    public void receipt3ShouldPass() {
        ...
        assertEquals("total must be 0", input.getTaxAmount(), new BigDecimal("6.70"));
